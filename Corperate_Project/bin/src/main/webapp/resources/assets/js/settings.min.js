...
`;(()=>{document.body.insertAdjacentHTML("beforeend",settingModal);const s=document.querySelector("#wrapper"),t=document.querySelector("#sidebar");if(new MutationObserver(()=>{sessionStorage.setItem("wrapper-class",s.className)}).observe(s,{attributes:!0}),document.addEventListener("change",e=>{if(e.target.closest(".theme-layout")){const a=e.target.closest(".theme-layout");a.checked?s.classList.add(a.value):s.classList.remove(a.value)}}),sessionStorage.getItem("wrapper-class")){const e=sessionStorage.getItem("wrapper-class");s.className=e}s.className&&(document.querySelector("#layout-fixed-sidebar").checked=s.className.split(" ").includes("fixed-sidebar"),document.querySelector("#layout-fixed-navbar").checked=s.className.split(" ").includes("fixed-navbar"),document.querySelector("#layout-fixed-footer").checked=s.className.split(" ").includes("fixed-footer"));function i(e){const a=document.querySelector("#sidebar-theme");a.href=a.href.replace(a.href.split("/").pop(),e),/light/.test(e)?(t.classList.remove("navbar-dark"),t.classList.add("navbar-light")):(t.classList.remove("navbar-light"),t.classList.add("navbar-dark"))}document.addEventListener("change",e=>{if(e.target.closest('input[name="sidebar-theme"]')){const a=e.target.closest('input[name="sidebar-theme"]');i(a.value),sessionStorage.setItem("sidebar-theme",a.value)}}),sessionStorage.getItem("sidebar-theme")&&(document.querySelector('input[name="sidebar-theme"][value="'+sessionStorage.getItem("sidebar-theme")+'"]').checked=!0,i(sessionStorage.getItem("sidebar-theme")))})();
